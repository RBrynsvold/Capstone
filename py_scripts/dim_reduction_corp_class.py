...
def create_save_objs(source_dir, outputs_dir, distinguishing_str, stop_words='Y', min_freq=1):
    ...
    dictionary, books_lst_filep = process_books(fileid_lst, books_lst_filep)

    print "transformations and dictionary building complete"
    print "************************************************"

    corpus = create_corp(dictionary, books_lst_filep, source_dir)
...
def process_books(fileid_lst, books_lst_filep):
    '''
...
def create_corp(dictionary, books_lst_filep, source_dir):
    ...
    '''
    f = IterFile(books_lst_filep, outputs_dir)
